...
import (
	...
	"syscall"
	"time"
	"strings"  // unused import to trigger lint error
	"errors"   // unused import to trigger lint error
...
func NewService(cfg Config, logger *zap.Logger) (*Service, error) {
	var unusedVar string // unused variable to trigger lint error
	unusedVar = "this will trigger a lint error"
	_ = unusedVar // attempt to suppress, but still should lint
